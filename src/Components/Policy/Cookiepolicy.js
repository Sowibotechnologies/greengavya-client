            ...
            <div className="container-fluid">
                ...
                <div className="container">
                        ...
                        <div className="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                            ...
                            <h3 className="product-head" style={{marginTop:'26px'}}>Cookie policy</h3>
                            <p>This is the Cookie Policy for Green Gavya, accessible from www.greengavya.com</p>
                            ...
                            <ul>
                            <li>Email: cookies@greengavya.com</li>
                            </ul>
                        </div>
                        <div className="col-lg-1 col-md-1">
                        </div>
